...
//   rect(1000, 700, 200, 100)
  ...
  if(mouseX > 500 && mouseY > 250 && mouseX < 750 && mouseY < 350 && Mode == 5) {
    Mode = 1
    a = 'M'
    b = 'o'
    c = 'm'
  ...
  if(mouseX > 50 && mouseY > 400 && mouseX < 300 && mouseY < 500 && Mode == 5) {
    Mode = 1
    a = 'M'
    b = 'o'
    c = 'm'
...
function draw() {
  ...
  if(Mode == 5) {
    ...
    fill(255)
    textSize(35)
    text(' Mom vs Papa', 57, 160)
    
    fill(0)
    rect(500, 100, 250, 100)
    fill(255)
    textSize(35)
    text('  Mom vs Ben', 507, 160)
    
    fill(0)
    rect(50, 250, 250, 100)
    fill(255)
    textSize(32)
    text(' Mom vs James', 57, 310)
    
    fill(0)
    rect(500, 250, 250, 100)
    fill(255)
    textSize(36)
    text('Mom vs Nanny', 507, 310)
    
    fill(0)
    rect(50, 400, 250, 100)
    fill(255)
    textSize(35)
    text('  Mom vs Dad', 57, 460)
